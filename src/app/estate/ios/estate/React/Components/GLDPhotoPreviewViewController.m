//
//  GLDPhotoPreviewViewController.m
//  estate
//
...
#import "GlodonPhotoPreviewCollectionViewCell.h"
...
@interface GLDPhotoPreviewViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UIScrollViewDelegate> {
...
@implementation GLDPhotoPreviewViewController
...
- (void)configCollectionView {
  ...
  [_collectionView registerClass:[GlodonPhotoPreviewCollectionViewCell class] forCellWithReuseIdentifier:@"LPDPhotoPreviewCell"];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
  GlodonPhotoPreviewCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"LPDPhotoPreviewCell" forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
  if ([cell isKindOfClass:[GlodonPhotoPreviewCollectionViewCell class]]) {
    [(GlodonPhotoPreviewCollectionViewCell *)cell recoverSubviews];
  }
}
