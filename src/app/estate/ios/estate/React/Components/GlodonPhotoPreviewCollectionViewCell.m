//
//  GlodonPhotoPreviewCollectionViewCell.m
//  estate
//
...
@interface GlodonPhotoPreviewCollectionViewCell ()<UIGestureRecognizerDelegate,UIScrollViewDelegate> {
  CGFloat _aspectRatio;
}
@end

@implementation GlodonPhotoPreviewCollectionViewCell
...
- (void)setModel:(LPDAssetModel *)model {
  ...
  if ([model.asset isKindOfClass:[NSDictionary class]]) {
    NSDictionary * data = model.asset;
    NSString * url = [data objectForKey:@"url"];
    [self.imageView loadImageWithURL:[NSURL URLWithString:url]];
    [self resizeSubviews];
    _progressView.hidden = YES;
