...
export default class Popover extends Component {
  ...
  buildProps() {
    ...
    const headerSize = Math.sqrt(arrowSize * arrowSize * 2) / 2 + borderWidth // The half-length of the square diagonal: sqrt(7^2 + 7^2) / 2 = 4.95
    const headerPadding = headerSize - arrowSize / 2 // Let the center of square on the edge: 5 - (7 / 2) = 1.5
    const headerPaddingCorner = paddingCorner || Theme.popoverPaddingCorner
    const contentPadding = headerSize - borderWidth
