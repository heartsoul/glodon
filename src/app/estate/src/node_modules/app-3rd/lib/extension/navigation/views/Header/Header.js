...
class Header extends React.PureComponent {
  ...
  _getLastScene(scene) {
    return null;// this.props.scenes.find(s => s.index === scene.index - 1);
  }
  ...
  _renderSubView(props, name, renderer, styleInterpolator) {
    ...
    const offset = 0;//this.props.navigation.state.index - index;
  ...
  _renderHeader(props={scene:{descriptor:{options:{title:'title',headerBackground:'#00b3a5'}},key:'abc'}}) {
    const { options } = props.scene.descriptor;
  ...
  render() {
    let appBar;
    const { mode='float', scene = {descriptor:{options:{
      title:'title',
    ...
    elevation: 0,}}}}, isLandscape=false } = this.props;
    ...
    //   });
    // }
    appBar = this._renderHeader({scene:scene});
