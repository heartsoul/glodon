...
class StackViewLayout extends React.Component {
  ...
  render() {
    ...
    return (
      <View {...handlers} style={[containerStyle,{width:WINDOW_WIDTH,height:WINDOW_HEIGHT,overflow:'hidden'}]}>
        <View style={[styles.scenes,{width:WINDOW_WIDTH,height:WINDOW_HEIGHT,backgroundColor:'white',position:'absolute',top:0,left:0,overflow:'hidden'}]}>
  ...
  _renderCard = scene => {
    ...
    return (
      <Card
        {...this.props.transitionProps}
        key={`card_${scene.key}`}
        style={[style, { marginTop:marginTop}, this.props.cardStyle]}
        scene={scene}
      >
