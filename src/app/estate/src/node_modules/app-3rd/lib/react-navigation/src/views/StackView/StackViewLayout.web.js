...
class StackViewLayout extends React.Component {
  ...
  render() {
    ...
    return (
      <View {...handlers} style={[containerStyle,{width:'100%',height:'100%',overflow:'hidden'}]}>
        <View style={[styles.scenes,{width:'100%',height:'100%',backgroundColor:'white',position:'absolute',top:0,left:0,overflow:'hidden'}]}>
