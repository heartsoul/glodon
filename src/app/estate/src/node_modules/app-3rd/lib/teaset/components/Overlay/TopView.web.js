...
function topView() {
    ...
    globalTopView = React.createElement(TopView, {});
    ReactDOM.render(globalTopView, div);
    lastDiv = div;
   return globalTopView;
}
...
export default class TopView extends Component {
  static add(element) {
    ...
    // alert(globalTopView);
    globalTopView = topView();
    setTimeout(()=>{
        globalTopView.add({ key, element })
    },100)
    return key
  }
  ...
  render() {
    ...
    left: 0,
    right: 0,
    bottom: 0, backgroundColor: 'transparent', flex: 1 }]}>
