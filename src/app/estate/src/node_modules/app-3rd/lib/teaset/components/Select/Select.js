...
export default class Select extends Component {
  ...
  get selectedIndex() {
    const { value, items, getItemValue } = this.props
  ...
  get valueText() {
    const { value, items, getItemValue, getItemText } = this.props
    let text = value
  ...
  showPullPicker() {
    const { pickerTitle, items, getItemText, onSelected } = this.props
  ...
  renderIconElement() {
    const { icon, iconTintColor, iconSize } = this.props
    let iconElement
  ...
  render() {
    ...
    const ViewClass = disabled ? View : TouchableOpacity
    return (
      <ViewClass
        style={style}
