...
export default class TabView extends Component {
  ...
  buildProps() {
    ...
    const { height, paddingTop, paddingBottom } = barStyle
  ...
  render() {
    ...
    const { barStyle, type, children, onChange, ...others } = props // disable View.onChange
    return (
      <View {...others}>
        {type === 'carousel'
          ? this.renderCarousel(props)
          : this.renderProjector(props)}
