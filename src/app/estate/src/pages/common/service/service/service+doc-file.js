 ...
 * @returns 同 parseListData 函数
 */
export function getDocFileSearch(containerId, name=null, suffix=null, path = null,createTimeFrom=null,createTimeTo=null,creatorId=null,creatorName=null) {
    return API.getDocFileSearch(containerId, fileId, orderByType, withPrivilege,folder,order,null)
        .then(response => {
            return parseListData(response);
        });
}
