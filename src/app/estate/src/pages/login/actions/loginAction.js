import {authaToken,setCurrentTenant,accountInfo,login as userLogin} from 'app-api'
...
export function loginOld(username, pwd) {
  return dispatch => {
    dispatch(isLogining())
...
// 访问登录接口 根据返回结果来划分action属于哪个type,然后返回对象,给reducer处理
export function loginNew(username, pwd) {
  return dispatch => {
    dispatch(isLogining())
